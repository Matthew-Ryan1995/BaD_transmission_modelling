...
Calculate the peaks from an epidemic for different values of the dear in and out.  socials fixed at 0.05 * fear
...
def calculate_peaks(idx_row):
    ...
    new_params["mask_social"] = row["w2"] * 0.05
