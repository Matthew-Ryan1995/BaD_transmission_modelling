...
w2 = np.arange(0, 10, step=1) * 0.05
w1 = 0.05*w2  # np.arange(0, 1, step=0.1)
w3 = np.arange(0, 1, step=0.1)
a2 = np.arange(0, 10, step=1)
a1 = 0.0 * a2  # np.arange(0, 1, step=0.1)
a3 = np.arange(0, 1, step=0.1)

w1 = w1[int((len(w1) - 1)/2)]
# w2 = w2[int((len(w2) - 1)/2)]
w3 = 0  # w3[int((len(w3) - 1)/2)]
a1 = 0  # a1[int((len(a1) - 1)/2)]
a2 = 0  # a2[int((len(a2) - 1)/2)]
a3 = 0.05  # a3[int((len(a3) - 1)/2)]
...
if __name__ == "__main__":
    ...
    plt.plot([w2[0], w2[-1]], [FS[1], FS[1]], ":k")
